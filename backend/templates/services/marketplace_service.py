...
from ..domain.exceptions import TemplateNotFoundError, SuniDefaultAgentTemplateError
...
class MarketplaceService:
    ...
    async def _is_template_from_suni_default_agent(self, template: AgentTemplate) -> bool:
    ...
    async def publish(
        ...
        if await self._is_template_from_suni_default_agent(template):
            raise SuniDefaultAgentTemplateError("Cannot publish templates created from the default Suni agent")
