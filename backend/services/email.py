...
class EmailService:
    def __init__(self):
        ...
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Suni Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Suni — Let's Get Started "
...
<head>
  ...
  <title>Welcome to Kortix Suni</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suni-logo.png" alt="Kortix Suni Logo" class="logo">
    </div>
    <h1>Welcome to Kortix Suni!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Kortix Suni — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Suni community <span class="emoji">🌞</span></p>

    <p>— The Suni Team</p>

    <a href="https://www.suni.so/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Suni — we're excited to have you on board!
...
Thanks again, and welcome to the Suni community 🌞

— The Suni Team

Go to the platform: https://www.suni.so/

---
© 2024 Suni. All rights reserved.
You received this email because you signed up for a Suni account."""
