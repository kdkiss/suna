...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Kortix Suni',
    description: 'Replay this Agent conversation on Kortix Suni',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Kortix Suni';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Kortix Suni';
