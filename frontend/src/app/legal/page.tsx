                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE SUNI
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE SUNI WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      SUNI DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
