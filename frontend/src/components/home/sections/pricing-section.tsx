  ...
  return (
    ...
    >
      ...
      {deploymentType === 'cloud' && (
       ...
       <div className="mt-4 p-4 bg-darkblue-50 dark:bg-darkblue-950/20 border border-darkblue-200 dark:border-darkblue-800 rounded-lg max-w-2xl mx-auto">
                <p className="text-sm text-darkblue-800 dark:text-darkblue-200 text-center">
