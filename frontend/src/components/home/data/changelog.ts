...
export const changeLogData: ChangelogData[] = [
    {
      ...
      description:
        "The most significant update for Suni yet. Build, customize, and share AI agents. Connect any service, automate complex workflows, and discover a thriving marketplace of community-built agents.",
      items: [
