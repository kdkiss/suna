        ...
        >
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Kortix Suni uses <b>LiteLLM</b> under the hood, which makes it compatible with over 100 models. You can easily choose any <a href="https://openrouter.ai/models" target="_blank" rel="noopener noreferrer" className="text-darkblue-500 hover:text-darkblue-600 underline">OpenRouter model</a> by prefixing it with <code className="bg-muted px-1.5 py-0.5 rounded text-sm font-mono">openrouter/</code> and it should work out of the box. If you want to use other models besides OpenRouter, you might have to modify the <a href="https://github.com/kortix-ai/suni/blob/main/backend/services/llm.py" target="_blank" rel="noopener noreferrer" className="text-darkblue-500 hover:text-darkblue-600 underline">llm.py</a>, set the correct environment variables, and rebuild your self-hosted Docker container.
                    </DialogDescription>
