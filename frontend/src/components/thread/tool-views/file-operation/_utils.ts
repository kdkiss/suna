...
export const getOperationConfigs = (): Record<FileOperation, OperationConfig> => {
  ...
  create: {
    ...
    edit: {
      icon: Replace,
      color: 'text-darkblue-600',
      successMessage: 'File edited successfully',
      progressMessage: 'Editing file...',
      bgColor: 'bg-darkblue-50',
      gradientBg: 'from-darkblue-50 to-darkblue-100',
      borderColor: 'border-darkblue-200',
      badgeColor: 'bg-darkblue-100 text-darkblue-700 border-darkblue-200',
      hoverColor: 'hover:bg-darkblue-100',
  },
  rewrite: {
    icon: Replace,
