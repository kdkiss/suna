# Suni Self-Hosting Guide

This guide provides detailed instructions for setting up and hosting your own instance of Suni, an open-source generalist AI agent.
...
- Start Suni using your preferred method
...
3. Create a Snapshot:
   - Name: `kortix/suni:0.1.3`
   - Image name: `kortix/suni:0.1.3`
...
Suni can be started in two ways:
...
For further assistance, join the [Suni Discord Community](https://discord.gg/Py6pCBUUPw) or check the [GitHub repository](https://github.com/kortix-ai/suni) for updates and issues.
